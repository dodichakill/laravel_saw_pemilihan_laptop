  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <form class="p-6 text-gray-900" action="{{ route('kriteria.store') }}" method="POST">
          @csrf
          @method('POST')
          <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
              {{ __('Buat Data Kriteria') }}
            </h2>
          ...
          <div class="mt-5">
            ...
            <x-text-input wire:model="form.nama_kriteria" name="nama_kriteria" class="block mt-1 w-full" type="text" name="nama_kriteria" required autofocus autocomplete="nama_kriteria" />
          ...
          <div class="mt-5">
            ...
            <x-text-input wire:model="form.atribut" name="atribut" class="block mt-1 w-full" type="text" name="atribut" required autofocus autocomplete="atribut" />
          ...
          <div class="mt-5">
            ...
            <x-text-input wire:model="form.bobot" name="bobot" class="block mt-1 w-full" type="text" name="bobot" required autofocus autocomplete="bobot" />
